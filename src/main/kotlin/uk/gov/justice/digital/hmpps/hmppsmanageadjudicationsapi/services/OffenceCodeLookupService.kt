...
class OffenceCodeLookupBuilder {
  ...
  fun buildlookup(): Map<Int, OffenceCodeDetails> {
    ...
    return OffenceCodeLookupBuilder()
      .code(1001).nomisCodes("1A", "1B").notCommittedOnOwnNomisCodes("25D").paragraph(paragraph1)
      .code(1002).nomisCodes("1A", "1J").notCommittedOnOwnNomisCodes("25F").paragraph(paragraph1)
      .code(1003).nomisCodes("1A", "1N").notCommittedOnOwnNomisCodes("25G").paragraph(paragraph1)
      .code(1004).nomisCodes("1A", "1F").notCommittedOnOwnNomisCodes("25E").paragraph(paragraph1)
      .code(1005).nomisCodes("1B").notCommittedOnOwnNomisCodes("25D").paragraph(paragraph1)
      .code(1006).nomisCodes("1J").notCommittedOnOwnNomisCodes("25F").paragraph(paragraph1)
      .code(1007).nomisCodes("1N").notCommittedOnOwnNomisCodes("25G").paragraph(paragraph1)
