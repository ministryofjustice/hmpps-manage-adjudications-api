...
class IncidentRoleRuleLookup {
  companion object {
    ...
    private val youthIncidentRuleDetailByRole = mapOf(
      ...
      INCITES_OTHER_TO_COMMIT_OFFENCE to Pair("29(b)", "Incites another prisoner to commit any of the foregoing offences:"),
      ASSISTS_OTHER_TO_COMMIT_OFFENCE to Pair("29(c)", "Assists another prisoner to commit, or to attempt to commit, any of the foregoing offences:"),
    )
