...
data class DraftAdjudicationDto(
  ...
  val id: Long,
  @ApiModelProperty(value = "The adjudication report number", notes = "Will only be present if this adjudication has been submitted to Prison-API", example = "4567123")
