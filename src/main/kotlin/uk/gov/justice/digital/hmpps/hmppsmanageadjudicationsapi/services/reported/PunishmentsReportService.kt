        ...
        .filter { punishment -> punishment.type.includeInSuspendedPunishments(includeAdditionalDays) }.map { punishment ->
          ...
          SuspendedPunishmentDto(
            ...
            punishment = PunishmentDto(
              ...
              schedule = PunishmentScheduleDto(suspendedUntil = schedule.suspendedUntil, duration = schedule.duration, measurement = Measurement.DAYS),
            ),
          )
        }
    }.flatten()
        ...
        it.getPunishments().filter { punishment -> punishment.type == punishmentType }.map { punishment ->
          ...
          AdditionalDaysDto(
            ...
            punishment = PunishmentDto(
              ...
              schedule = PunishmentScheduleDto(duration = schedule.duration, measurement = Measurement.DAYS),
            ),
          )
        }
      }.flatten()
