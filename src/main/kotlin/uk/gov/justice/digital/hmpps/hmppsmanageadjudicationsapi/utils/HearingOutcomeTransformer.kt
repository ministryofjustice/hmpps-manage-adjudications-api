...
object HearingOutcomeTransformer {
  fun displayOutcomeCodeName(status: HearingOutcomeCode): String? {
    return when (status) {
  ...
  fun displayOutcomePleaName(status: HearingOutcomePlea): String? {
    return when (status) {
   ...
   */
  fun displayOutcomeCodeName(status: String): String? {
    return try {
   ...
   * If invalid, return null or any fallback behavior you prefer.
   */
  fun displayOutcomePleaName(status: String): String? {
    return try {
