...
enum class AdjudicationDomainEventType(val value: String, val description: String, val auditType: AuditType) {
  ...
  HEARING_ADJOURN_CREATED("adjudication.adjourn.created", "Adjudication hearing adjourn created: ", AuditType.HEARING_ADJOURN_CREATED),
  HEARING_ADJOURN_DELETED("adjudication.adjourn.deleted", "Adjudication hearing adjourn deleted: ", AuditType.HEARING_ADJOURN_DELETED),
