...
enum class AdjudicationDomainEventType(val value: String, val description: String, val auditType: AuditType, val incHearingId: Boolean = false) {
  ...
  HEARING_COMPLETED_CREATED("adjudication.hearingCompleted.created", "Adjudication hearing completed created: ", AuditType.HEARING_COMPLETED_CREATED, true),
  HEARING_COMPLETED_DELETED("adjudication.hearingCompleted.deleted", "Adjudication hearing completed deleted: ", AuditType.HEARING_COMPLETED_DELETED, true),
  HEARING_REFERRAL_CREATED("adjudication.hearingReferral.created", "Adjudication hearing referral created: ", AuditType.HEARING_REFERRAL_CREATED, true),
  HEARING_REFERRAL_DELETED("adjudication.hearingReferral.deleted", "Adjudication hearing referral deleted: ", AuditType.HEARING_REFERRAL_DELETED, true),
  HEARING_ADJOURN_CREATED("adjudication.hearingAdjourn.created", "Adjudication hearing adjourn created: ", AuditType.HEARING_ADJOURN_CREATED, true),
  HEARING_ADJOURN_DELETED("adjudication.hearingAdjourn.deleted", "Adjudication hearing adjourn deleted: ", AuditType.HEARING_ADJOURN_DELETED, true),
  HEARING_OUTCOME_UPDATED("adjudication.hearingOutcome.updated", "Adjudication hearing outcome updated: ", AuditType.HEARING_OUTCOME_UPDATED, true),
  ...
  PROSECUTION_REFERRAL_OUTCOME("adjudication.referral.outcome.prosecution", "Adjudication prosecution from referral: ", AuditType.REFERRAL_OUTCOME_PROSECUTION, true),
  NOT_PROCEED_REFERRAL_OUTCOME("adjudication.referral.outcome.notProceed", "Adjudication not proceed from referral: ", AuditType.REFERRAL_OUTCOME_NOT_PROCEED, true),
  REFERRAL_OUTCOME_DELETED("adjudication.referral.outcome.deleted", "Adjudication referral outcome deleted: ", AuditType.REFERRAL_OUTCOME_DELETED, true),
