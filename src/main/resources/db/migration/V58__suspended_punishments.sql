ALTER TABLE punishment ADD COLUMN activated_from bigint;
ALTER TABLE punishment ADD COLUMN activated_by bigint;
ALTER TABLE punishment ADD COLUMN suspended_until date;
