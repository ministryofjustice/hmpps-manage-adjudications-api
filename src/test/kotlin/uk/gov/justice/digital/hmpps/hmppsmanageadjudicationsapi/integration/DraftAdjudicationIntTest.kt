...
class DraftAdjudicationIntTest : IntegrationTestBase() {
  ...
  fun `complete draft adjudication`() {
    ...
    webTestClient.post()
      ...
      .jsonPath("$.offenceDetails[0].offenceCode").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[0].offenceCode)
      .jsonPath("$.offenceDetails[0].offenceRule.paragraphNumber").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[0].paragraphNumber)
      .jsonPath("$.offenceDetails[0].offenceRule.paragraphDescription").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[0].paragraphDescription)
      .jsonPath("$.offenceDetails[0].victimPrisonersNumber").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[0].victimPrisonersNumber)
      .jsonPath("$.offenceDetails[0].victimStaffUsername").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[0].victimStaffUsername)
      .jsonPath("$.offenceDetails[0].victimOtherPersonsName").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[0].victimOtherPersonsName)
      .jsonPath("$.offenceDetails[1].offenceCode").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[1].offenceCode)
      .jsonPath("$.offenceDetails[1].offenceRule.paragraphNumber").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[1].paragraphNumber)
      .jsonPath("$.offenceDetails[1].offenceRule.paragraphDescription").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[1].paragraphDescription)
  ...
  fun `complete draft update of existing adjudication`() {
    ...
    webTestClient.post()
      ...
      .jsonPath("$.offenceDetails[0].offenceCode").isEqualTo(IntegrationTestData.UPDATED_ADJUDICATION.offences[0].offenceCode)
      .jsonPath("$.offenceDetails[0].offenceRule.paragraphNumber").isEqualTo(IntegrationTestData.UPDATED_ADJUDICATION.offences[0].paragraphNumber)
      .jsonPath("$.offenceDetails[0].offenceRule.paragraphDescription").isEqualTo(IntegrationTestData.UPDATED_ADJUDICATION.offences[0].paragraphDescription)
