...
class DraftAdjudicationIntTest : IntegrationTestBase() {
  ...
  fun `get previously submitted draft adjudication details`() {
    ...
    webTestClient.get()
      ...
      .jsonPath("$.draftAdjudication.offenceDetails[0].paragraphNumber").isEqualTo(testAdjudication.offences[0].paragraphNumber)
      .jsonPath("$.draftAdjudication.offenceDetails[0].paragraphDescription").isEqualTo(testAdjudication.offences[0].paragraphDescription)
      ...
      .jsonPath("$.draftAdjudication.offenceDetails[1].paragraphNumber").isEqualTo(testAdjudication.offences[1].paragraphNumber)
      .jsonPath("$.draftAdjudication.offenceDetails[1].paragraphDescription").isEqualTo(testAdjudication.offences[1].paragraphDescription)
  ...
  fun `edit offence details for the draft adjudication`() {
    ...
    webTestClient.put()
      ...
      .jsonPath("$.draftAdjudication.offenceDetails[0].paragraphNumber").isEqualTo(IntegrationTestData.BASIC_OFFENCE.paragraphNumber)
      .jsonPath("$.draftAdjudication.offenceDetails[0].paragraphDescription").isEqualTo(IntegrationTestData.BASIC_OFFENCE.paragraphDescription)
  ...
  fun `complete draft adjudication`() {
    ...
    webTestClient.post()
      ...
      .jsonPath("$.offences[0].paragraphNumber").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[0].paragraphNumber)
      .jsonPath("$.offences[0].paragraphDescription").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[0].paragraphDescription)
      ...
      .jsonPath("$.offences[1].paragraphNumber").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[1].paragraphNumber)
      .jsonPath("$.offences[1].paragraphDescription").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[1].paragraphDescription)
  ...
  fun `complete draft update of existing adjudication`() {
    ...
    webTestClient.post()
      ...
      .jsonPath("$.offences[0].paragraphNumber").isEqualTo(IntegrationTestData.UPDATED_ADJUDICATION.offences[0].paragraphNumber)
      .jsonPath("$.offences[0].paragraphDescription").isEqualTo(IntegrationTestData.UPDATED_ADJUDICATION.offences[0].paragraphDescription)
