...
class DraftAdjudicationIntTest : IntegrationTestBase() {
  ...
  fun `makes a request to start a new draft adjudication`() {
    webTestClient.post()
      ...
      .jsonPath("$.draftAdjudication.incidentRole.offenceRule.paragraphDescription").isEqualTo("Attempts to commit any of the foregoing offences:")
  ...
  fun `get draft adjudication details`() {
    ...
    webTestClient.get()
      ...
      .jsonPath("$.draftAdjudication.incidentRole.offenceRule.paragraphNumber").isEqualTo(testAdjudication.incidentRoleParagraphNumber)
      .jsonPath("$.draftAdjudication.incidentRole.offenceRule.paragraphDescription").isEqualTo(testAdjudication.incidentRoleParagraphDescription)
  ...
  fun `get previously submitted draft adjudication details`() {
    ...
    webTestClient.get()
      ...
      .jsonPath("$.draftAdjudication.offenceDetails[0].offenceRule.paragraphNumber").isEqualTo(testAdjudication.offences[0].paragraphNumber)
      .jsonPath("$.draftAdjudication.offenceDetails[0].offenceRule.paragraphDescription").isEqualTo(testAdjudication.offences[0].paragraphDescription)
      ...
      .jsonPath("$.draftAdjudication.offenceDetails[0].victimStaffUsername").isEqualTo(testAdjudication.offences[0].victimStaffUsername)
      .jsonPath("$.draftAdjudication.offenceDetails[0].victimOtherPersonsName").isEqualTo(testAdjudication.offences[0].victimOtherPersonsName)
      .jsonPath("$.draftAdjudication.offenceDetails[1].offenceCode").isEqualTo(testAdjudication.offences[1].offenceCode)
      .jsonPath("$.draftAdjudication.offenceDetails[1].offenceRule.paragraphNumber").isEqualTo(testAdjudication.offences[1].paragraphNumber)
      .jsonPath("$.draftAdjudication.offenceDetails[1].offenceRule.paragraphDescription").isEqualTo(testAdjudication.offences[1].paragraphDescription)
  ...
  fun `edit offence details for the draft adjudication`() {
    ...
    webTestClient.put()
      ...
      .jsonPath("$.draftAdjudication.incidentRole.offenceRule.paragraphDescription").isEqualTo(testAdjudication.incidentRoleParagraphDescription)
      .jsonPath("$.draftAdjudication.incidentRole.associatedPrisonersNumber").isEqualTo(testAdjudication.incidentRoleAssociatedPrisonersNumber)
      .jsonPath("$.draftAdjudication.offenceDetails[0].offenceCode").isEqualTo(IntegrationTestData.BASIC_OFFENCE.offenceCode)
      .jsonPath("$.draftAdjudication.offenceDetails[0].offenceRule.paragraphNumber").isEqualTo(IntegrationTestData.BASIC_OFFENCE.paragraphNumber)
      .jsonPath("$.draftAdjudication.offenceDetails[0].offenceRule.paragraphDescription").isEqualTo(IntegrationTestData.BASIC_OFFENCE.paragraphDescription)
  ...
  fun `complete draft adjudication`() {
    ...
    webTestClient.post()
      ...
      .jsonPath("$.incidentRole.offenceRule.paragraphDescription").isEqualTo(DEFAULT_INCIDENT_ROLE_PARAGRAPH_DESCRIPTION)
      .jsonPath("$.incidentRole.associatedPrisonersNumber").isEqualTo(DEFAULT_INCIDENT_ROLE_ASSOCIATED_PRISONER)
      .jsonPath("$.offences[0].offenceCode").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[0].offenceCode)
      .jsonPath("$.offences[0].offenceRule.paragraphNumber").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[0].paragraphNumber)
      .jsonPath("$.offences[0].offenceRule.paragraphDescription").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[0].paragraphDescription)
      .jsonPath("$.offences[0].victimPrisonersNumber").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[0].victimPrisonersNumber)
      .jsonPath("$.offences[0].victimStaffUsername").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[0].victimStaffUsername)
      .jsonPath("$.offences[0].victimOtherPersonsName").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[0].victimOtherPersonsName)
      .jsonPath("$.offences[1].offenceCode").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[1].offenceCode)
      .jsonPath("$.offences[1].offenceRule.paragraphNumber").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[1].paragraphNumber)
      .jsonPath("$.offences[1].offenceRule.paragraphDescription").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[1].paragraphDescription)
      .jsonPath("$.offences[1].victimPrisonersNumber").doesNotExist()
      .jsonPath("$.offences[1].victimStaffUsername").doesNotExist()
      .jsonPath("$.offences[1].victimOtherPersonsName").doesNotExist()
  ...
  fun `complete draft update of existing adjudication`() {
    ...
    webTestClient.post()
      ...
      .jsonPath("$.incidentRole.offenceRule.paragraphDescription").isEqualTo(UPDATED_INCIDENT_ROLE_PARAGRAPH_DESCRIPTION)
      .jsonPath("$.incidentRole.associatedPrisonersNumber").isEqualTo(UPDATED_INCIDENT_ROLE_ASSOCIATED_PRISONER)
      .jsonPath("$.offences[0].offenceCode").isEqualTo(IntegrationTestData.UPDATED_ADJUDICATION.offences[0].offenceCode)
      .jsonPath("$.offences[0].offenceRule.paragraphNumber").isEqualTo(IntegrationTestData.UPDATED_ADJUDICATION.offences[0].paragraphNumber)
      .jsonPath("$.offences[0].offenceRule.paragraphDescription").isEqualTo(IntegrationTestData.UPDATED_ADJUDICATION.offences[0].paragraphDescription)
      .jsonPath("$.offences[0].victimPrisonersNumber").doesNotExist()
      .jsonPath("$.offences[0].victimStaffUsername").doesNotExist()
      .jsonPath("$.offences[0].victimOtherPersonsName").doesNotExist()
  ...
  fun `returns all in progress draft adjudications created by the current user in the given caseload`() {
    ...
    webTestClient.get()
      ...
      .jsonPath("$.draftAdjudications[0].incidentRole.offenceRule.paragraphNumber").isEqualTo(testAdjudication.incidentRoleParagraphNumber)
      .jsonPath("$.draftAdjudications[0].incidentRole.offenceRule.paragraphDescription").isEqualTo(testAdjudication.incidentRoleParagraphDescription)
