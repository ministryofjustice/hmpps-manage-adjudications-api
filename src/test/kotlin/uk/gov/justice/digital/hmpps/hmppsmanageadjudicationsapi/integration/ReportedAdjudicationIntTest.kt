...
class ReportedAdjudicationIntTest : IntegrationTestBase() {
  ...
  fun `return a page of reported adjudications completed by the current user`() {
    ...
    webTestClient.get()
      ...
      // TODO - Fix when flag implemented in draft
      .jsonPath("$.content[0].isYouthOffender").isEqualTo(false) // .isEqualTo(IntegrationTestData.ADJUDICATION_4.isYouthOffender)
