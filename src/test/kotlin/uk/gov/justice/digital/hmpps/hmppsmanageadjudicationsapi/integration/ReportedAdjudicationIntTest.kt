...
class ReportedAdjudicationIntTest : IntegrationTestBase() {
  ...
  fun `get reported adjudication details`() {
    ...
    webTestClient.get()
      ...
      .jsonPath("$.reportedAdjudication.offences[0].offenceRule.paragraphNumber").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[0].paragraphNumber)
      .jsonPath("$.reportedAdjudication.offences[0].offenceRule.paragraphDescription").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[0].paragraphDescription)
      ...
      .jsonPath("$.reportedAdjudication.offences[0].victimStaffUsername").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[0].victimStaffUsername)
      .jsonPath("$.reportedAdjudication.offences[0].victimOtherPersonsName").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[0].victimOtherPersonsName)
      ...
      .jsonPath("$.reportedAdjudication.offences[1].offenceRule.paragraphNumber").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[1].paragraphNumber)
      .jsonPath("$.reportedAdjudication.offences[1].offenceRule.paragraphDescription").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[1].paragraphDescription)
      .jsonPath("$.reportedAdjudication.offences[1].victimPrisonersNumber").doesNotExist()
      .jsonPath("$.reportedAdjudication.offences[1].victimStaffUsername").doesNotExist()
      .jsonPath("$.reportedAdjudication.offences[1].victimOtherPersonsName").doesNotExist()
  ...
  fun `return a page of reported adjudications completed by the current user`() {
    ...
    webTestClient.get()
      ...
      .jsonPath("$.content[0].offences[0].offenceRule.paragraphNumber").isEqualTo(IntegrationTestData.ADJUDICATION_4.offences[0].paragraphNumber)
      .jsonPath("$.content[0].offences[0].offenceRule.paragraphDescription").isEqualTo(IntegrationTestData.ADJUDICATION_4.offences[0].paragraphDescription)
      ...
      .jsonPath("$.content[0].offences[0].victimStaffUsername").isEqualTo(IntegrationTestData.ADJUDICATION_4.offences[0].victimStaffUsername)
      .jsonPath("$.content[0].offences[0].victimOtherPersonsName").isEqualTo(IntegrationTestData.ADJUDICATION_4.offences[0].victimOtherPersonsName)
      .jsonPath("$.content[0].offences[1].offenceCode").isEqualTo(IntegrationTestData.ADJUDICATION_4.offences[1].offenceCode)
      .jsonPath("$.content[0].offences[1].offenceRule.paragraphNumber").isEqualTo(IntegrationTestData.ADJUDICATION_4.offences[1].paragraphNumber)
      .jsonPath("$.content[0].offences[1].offenceRule.paragraphDescription").isEqualTo(IntegrationTestData.ADJUDICATION_4.offences[1].paragraphDescription)
      .jsonPath("$.content[0].offences[1].offenceCode").isEqualTo(IntegrationTestData.ADJUDICATION_4.offences[1].offenceCode)
      .jsonPath("$.content[0].offences[1].victimPrisonersNumber").doesNotExist()
      .jsonPath("$.content[0].offences[1].victimStaffUsername").doesNotExist()
      .jsonPath("$.content[0].offences[1].victimOtherPersonsName").doesNotExist()
  ...
  fun `return a page of reported adjudications completed in the current agency`() {
    ...
    webTestClient.get()
      ...
      .jsonPath("$.content[0].offences[0].offenceRule.paragraphNumber").isEqualTo(IntegrationTestData.ADJUDICATION_3.offences[0].paragraphNumber)
      .jsonPath("$.content[0].offences[0].offenceRule.paragraphDescription").isEqualTo(IntegrationTestData.ADJUDICATION_3.offences[0].paragraphDescription)
      ...
      .jsonPath("$.content[0].offences[0].victimStaffUsername").isEqualTo(IntegrationTestData.ADJUDICATION_3.offences[0].victimStaffUsername)
      .jsonPath("$.content[0].offences[0].victimOtherPersonsName").isEqualTo(IntegrationTestData.ADJUDICATION_3.offences[0].victimOtherPersonsName)
      .jsonPath("$.content[0].offences[1].offenceCode").isEqualTo(IntegrationTestData.ADJUDICATION_3.offences[1].offenceCode)
      .jsonPath("$.content[0].offences[1].offenceRule.paragraphNumber").isEqualTo(IntegrationTestData.ADJUDICATION_3.offences[1].paragraphNumber)
      .jsonPath("$.content[0].offences[1].offenceRule.paragraphDescription").isEqualTo(IntegrationTestData.ADJUDICATION_3.offences[1].paragraphDescription)
      .jsonPath("$.content[0].offences[1].offenceCode").isEqualTo(IntegrationTestData.ADJUDICATION_3.offences[1].offenceCode)
      .jsonPath("$.content[0].offences[1].victimPrisonersNumber").doesNotExist()
      .jsonPath("$.content[0].offences[1].victimStaffUsername").doesNotExist()
      .jsonPath("$.content[0].offences[1].victimOtherPersonsName").doesNotExist()
