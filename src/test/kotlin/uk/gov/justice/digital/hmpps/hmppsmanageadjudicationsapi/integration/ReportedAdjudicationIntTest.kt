...
class ReportedAdjudicationIntTest : IntegrationTestBase() {
  ...
  fun `get reported adjudication details`() {
    ...
    webTestClient.get()
      ...
      .jsonPath("$.reportedAdjudication.offences[0].paragraphNumber").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[0].paragraphNumber)
      .jsonPath("$.reportedAdjudication.offences[0].paragraphDescription").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[0].paragraphDescription)
      ...
      .jsonPath("$.reportedAdjudication.offences[1].paragraphNumber").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[1].paragraphNumber)
      .jsonPath("$.reportedAdjudication.offences[1].paragraphDescription").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[1].paragraphDescription)
  ...
  fun `return a page of reported adjudications completed by the current user`() {
    ...
    webTestClient.get()
      ...
      .jsonPath("$.content[0].offences[0].paragraphNumber").isEqualTo(IntegrationTestData.ADJUDICATION_4.offences[0].paragraphNumber)
      .jsonPath("$.content[0].offences[0].paragraphDescription").isEqualTo(IntegrationTestData.ADJUDICATION_4.offences[0].paragraphDescription)
      ...
      .jsonPath("$.content[0].offences[1].paragraphNumber").isEqualTo(IntegrationTestData.ADJUDICATION_4.offences[1].paragraphNumber)
      .jsonPath("$.content[0].offences[1].paragraphDescription").isEqualTo(IntegrationTestData.ADJUDICATION_4.offences[1].paragraphDescription)
      .jsonPath("$.content[0].offences[1].offenceCode").isEqualTo(IntegrationTestData.ADJUDICATION_4.offences[1].offenceCode)
  ...
  fun `return a page of reported adjudications completed in the current agency`() {
    ...
    webTestClient.get()
      ...
      .jsonPath("$.content[0].offences[0].paragraphNumber").isEqualTo(IntegrationTestData.ADJUDICATION_3.offences[0].paragraphNumber)
      .jsonPath("$.content[0].offences[0].paragraphDescription").isEqualTo(IntegrationTestData.ADJUDICATION_3.offences[0].paragraphDescription)
      ...
      .jsonPath("$.content[0].offences[1].paragraphNumber").isEqualTo(IntegrationTestData.ADJUDICATION_3.offences[1].paragraphNumber)
      .jsonPath("$.content[0].offences[1].paragraphDescription").isEqualTo(IntegrationTestData.ADJUDICATION_3.offences[1].paragraphDescription)
      .jsonPath("$.content[0].offences[1].offenceCode").isEqualTo(IntegrationTestData.ADJUDICATION_3.offences[1].offenceCode)
      .jsonPath("$.content[0].offences[1].victimPrisonersNumber").doesNotExist()
      .jsonPath("$.content[0].offences[1].victimStaffUsername").doesNotExist()
      .jsonPath("$.content[0].offences[1].victimOtherPersonsName").doesNotExist()
  ...
  fun `create draft from reported adjudication returns expected result`() {
    ...
    webTestClient.post()
      ...
      .jsonPath("$.draftAdjudication.offenceDetails[0].paragraphNumber").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[0].paragraphNumber)
      .jsonPath("$.draftAdjudication.offenceDetails[0].paragraphDescription").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[0].paragraphDescription)
      ...
      .jsonPath("$.draftAdjudication.offenceDetails[1].paragraphNumber").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[1].paragraphNumber)
      .jsonPath("$.draftAdjudication.offenceDetails[1].paragraphDescription").isEqualTo(IntegrationTestData.DEFAULT_ADJUDICATION.offences[1].paragraphDescription)
