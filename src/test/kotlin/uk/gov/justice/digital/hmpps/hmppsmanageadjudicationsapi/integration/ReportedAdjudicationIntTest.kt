...
class ReportedAdjudicationIntTest : IntegrationTestBase() {
  ...
  fun `return a page of reported adjudications completed by the current user`() {
    ...
    webTestClient.get()
      ...
      .jsonPath("$.content[0].isYouthOffender").isEqualTo(IntegrationTestData.ADJUDICATION_4.isYouthOffender)
      ...
      .jsonPath("$.content[0].offenceDetails[0].victimPrisonersNumber").doesNotExist()
      .jsonPath("$.content[0].offenceDetails[0].victimStaffUsername").doesNotExist()
      .jsonPath("$.content[0].offenceDetails[0].victimOtherPersonsName").doesNotExist()
      .jsonPath("$.content[0].offenceDetails[1]").doesNotExist()
  ...
  fun `return a page of reported adjudications completed in the current agency`() {
    ...
    webTestClient.get()
      ...
      .jsonPath("$.content[0].isYouthOffender").isEqualTo(IntegrationTestData.ADJUDICATION_3.isYouthOffender)
